...
interface EditorialQueueViewProps {
  onEditArticle?: (art: Article) => void;
}

export const EditorialQueueView: React.FC<EditorialQueueViewProps> = ({ onEditArticle }) => {
  ...
  const handleSendComment = (e?: React.FormEvent) => {
    ...
    // Atualiza o estado local com o novo balão
  ...
  // =========================================================================
  // CASO 1: PÁGINA COMPLETA DE REVISÃO EDITORIAL (NÃO MODAL / NÃO JANELA FLUTUANTE)
  // =========================================================================
  if (selectedReviewArticle) {
    return (
      <div
        style={{
          display: 'flex',
      ...
      >
        {/* Header Superior da Página de Revisão */}
        <div
          style={{
            padding: '16px 28px',
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flexWrap: 'wrap' }}>
            <button
              ...
              title="Voltar para a Fila de Revisão"
            >
              <ArrowLeft size={14} />
            ...
            <div>
              <h1 style={{ fontSize: '1.25rem', color: 'var(--text-main)', margin: 0, fontWeight: 800 }}>
                {selectedReviewArticle.title}
              </h1>
              <div style={{ fontSize: '0.76rem', color: 'var(--text-subtle)', display: 'flex', alignItems: 'center', gap: '12px', marginTop: '2px', flexWrap: 'wrap' }}>
                ...
                <span>•</span>
                <span><strong>Criado em:</strong> {new Date(selectedReviewArticle.createdAt).toLocaleString('pt-BR')}</span>
              </div>
            </div>
          </div>

          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            {/* BOTÃO PARA EDITAR E FAZER MODIFICAÇÕES PONTUAIS */}
            {onEditArticle && (
              <button
                type="button"
                className="btn btn-secondary btn-sm"
                onClick={() => onEditArticle(selectedReviewArticle)}
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: '6px',
                ...
                title="Editar este artigo para fazer modificações pontuais no conteúdo"
              >
                <FileEdit size={15} />
        ...
        {/* Corpo Principal da Página: Lado Esquerdo (Balões & Conversa) vs Lado Direito (Conteúdo do Artigo) */}
          ...
          >
            ...
            >
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                <textarea
                  rows={2}
                  placeholder="Digite sua mensagem, orientação ou resposta..."
          ...
          >
            <div style={{ maxWidth: '960px', width: '100%', margin: '0 auto' }}>
              ...
              <div style={{ marginBottom: '24px', paddingBottom: '16px', borderBottom: '1px solid var(--border-subtle)' }}>
                <h1 style={{ fontSize: '1.75rem', color: 'var(--text-main)', margin: '0 0 10px 0', fontWeight: 800 }}>
                  {selectedReviewArticle.title}
                </h1>
  ...
  // =========================================================================
  // CASO 2: LISTAGEM DA FILA EDITORIAL (QUANDO NENHUM ARTIGO ESTÁ SENDO AVALIADO)
  // =========================================================================
  return (
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 600,
            cursor: 'pointer',
            background: activeTab === 'IN_ADJUSTMENT' ? 'rgba(245, 158, 11, 0.15)' : 'transparent',
            color: activeTab === 'IN_ADJUSTMENT' ? '#f59e0b' : 'var(--text-muted)',
            border: `1px solid ${activeTab === 'IN_ADJUSTMENT' ? 'rgba(245, 158, 11, 0.4)' : 'transparent'}`,
            display: 'flex',
            alignItems: 'center',
            gap: '8px',
          }}
